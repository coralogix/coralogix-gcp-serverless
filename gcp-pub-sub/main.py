...
__credits__ = ['Ariel Assaraf', 'Amnon Shahar', 'Eldar Aliiev', 'Tal Knopf']
__license__ = 'Apache Version 2.0'
__version__ = '1.0.0'
__maintainer__ = 'Coralogix Ltd.'
__date__ = '7 April 2022'
__status__ = 'Stable'
...
def to_coralogix(event, context):
    ...
    try:
        ...
        print("Failed to initialize logger object")
    ...
    try:
        ...
        print("Failed to send logs to coralogix")